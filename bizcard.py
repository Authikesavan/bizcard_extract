...
icon = Image.open('main.webp')
image1= Image.open('use4.webp')
...
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR ",
                   ...
                   menu_items={'About': """#THIS APP IS USED FOR EXTRACTING CARD DATA!"""})
...
if selected == "Home":
        st.image("main.webp")
        st.markdown("## :green[**REQUIREMENTS :**] Python,easy OCR, Streamlit, SQL, Pandas")
        st.markdown("## :green[**BRIEF :**]  It uses Object Character Recognition (easyOCR) for recording accurate text from the scanned images.Business cards are highly customizable, and companies can choose to include as much or as little information as they wish, depending on their brand strategy and organizational structure.")
...
if selected == "Modify":
    ...
    try:
        with column1:
            ...
            mycursor.execute("select company_name,card_holder,designation,mobile_number,email,website,area,city,state,pin_code from card_db WHERE card_holder=%s",
                            (selected_card,))
            ...
            if st.button("Commit changes to DB"):
                ...
                mycursor.execute("""UPDATE card_db SET company_name=%s,card_holder=%s,designation=%s,mobile_number=%s,email=%s,website=%s,area=%s,city=%s,state=%s,pin_code=%s
        ...
        st.markdown("the following is the data")
